...
import com.yourorg.crawling.port.out.message.NewsRequestPort;
...
public class CrawlingService implements CrawlingTriggerPort {
    ...
    private final NewsRequestPort newsRequestPort;
                ...
                try {
                    ...
                    for (Element li : newsListUl.select("li")) {
                        ...
                        NewsRequestDto newsRequestDto = new NewsRequestDto(
                            ...
                            news.getTitle(),
                            news.getCategory(),
                            news.getUploadAt().toString(),
                            news.getNewsLink(),
                            news.getImgLink()
                        );
                        newsRequestPort.requestNews(newsRequestDto);

                        // 출력
                        System.out.println("\n".repeat(40));
                        System.out.println("뉴스 ID: " + news.getNewsId());
